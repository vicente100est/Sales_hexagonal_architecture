...
namespace AppVenta.Infraestructura.API.Controllers
{
    ...
    public class ProductoController : ControllerBase
    {
        ...
        public ActionResult Post([FromBody] Producto producto)
        {
            ...
            return Ok("Se ha agregado Producto de forma satisfactoria");
        }
        ...
        public ActionResult Put(Guid id, [FromBody] Producto producto)
        {
            ...
            return Ok("Se ha editado el Producto de forma satisfactoria");
        }
        ...
        public ActionResult Delete(Guid id)
        {
            ...
            return Ok("Se ha eliminado el Producto de forma satisfactoria");
        }
    }
}
